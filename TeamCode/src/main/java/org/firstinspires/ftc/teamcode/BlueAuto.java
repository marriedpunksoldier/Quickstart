        ...
        public Paths(Follower follower) {
            Shoot1 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(66.89950576606262, 86.82701812191104)
                            )
            ...
            Waypoint1 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(53.14003294892916, 35.11037891268535)
                            )
            ...
            Waypoint2 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(29.17957166392092, 35.584843492586494)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
            ...
            Waypoint3 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(53.14003294892916, 35.110378912685356)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
            ...
            Waypoint4 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(52.665568369028, 60.01976935749587)
                            )
            ...
            Waypoint5 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(32.50082372322899, 59.782537067545285)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
            ...
            Waypoint7 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(48.158154859967055, 83.74299835255356)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(143), Math.toRadians(180))
            ...
            Waypoint8 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(29.17957166392092, 83.74299835255354)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
