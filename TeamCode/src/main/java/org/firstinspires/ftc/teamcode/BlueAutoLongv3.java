...
public class BlueAutoLongv3 extends OpMode {
    ...
    // Shooting positions
    private final Pose shoot1Pose = new Pose(53.614497528830306, 100.58649093904447, Math.toRadians(143));
    private final Pose shoot2Pose = new Pose(53.614497528830306, 100.58649093904447, Math.toRadians(143));
    private final Pose shoot3Pose = new Pose(53.614497528830306, 100.58649093904447, Math.toRadians(143));
    private final Pose shoot4Pose = new Pose(53.614497528830306, 100.58649093904447, Math.toRadians(143));
        ...
        switch (pathState) {
            ...
            case 2:
                ...
                if (shooterVelocityReached ||
                    ...
                    // Only use pusher after the second ball (ballsShot >= 2)
                    if (ballsShot >= 2) {
                        pushSample();
                    }
                    setPathState(3);
            ...
            case 3:
                // Wait for ball to shoot (push time if pusher used, otherwise just wait)
